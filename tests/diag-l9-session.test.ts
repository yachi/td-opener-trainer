...
import {
  type Session,
  type SessionAction as Action,
  createSession,
  sessionReducer as reduce,
} from '../src/session.ts';

// ═══════════════════════════════════════════════════════════════════════════
// Reference reducer extracted to src/session.ts (Phase 3a). The 44 tests in
// this file remain the design contract — they must keep passing against the
