...
const MS2_BAG2_ROUTES: Bag2Route[] = [
  {
    ...
    placements: [
      ...
      { piece: 'L', cells: [{ col: 0, row: 13 }, { col: 1, row: 13 }, { col: 1, row: 14 }, { col: 1, row: 15 }], hint: 'L vertical, cols 0-1' },
    ],
    tstStepIndex: -1,
  },
  {
...
const STRAY_CANNON_BAG2_ROUTES: Bag2Route[] = [
  {
    ...
    placements: [
      ...
      { piece: 'S', cells: [{ col: 0, row: 15 }, { col: 0, row: 16 }, { col: 1, row: 16 }, { col: 1, row: 17 }], hint: 'S vertical, cols 0-1, left wall' },
...
const GAMUSHIRO_BAG2_ROUTES: Bag2Route[] = [
  ...
  },
  {
    ...
    placements: [
      ...
      { piece: 'S', cells: [{ col: 6, row: 15 }, { col: 7, row: 15 }, { col: 5, row: 16 }, { col: 6, row: 16 }], hint: 'S flat, cols 5-7' },
      { piece: 'I', cells: [{ col: 0, row: 12 }, { col: 0, row: 13 }, { col: 0, row: 14 }, { col: 0, row: 15 }], hint: 'I vertical, col 0, left wall' },
      { piece: 'L', cells: [{ col: 8, row: 13 }, { col: 9, row: 13 }, { col: 9, row: 14 }, { col: 9, row: 15 }], hint: 'L vertical, cols 8-9' },
    ],
    tstStepIndex: -1,
  },
];
