...
// Route 8 (fb_o_top_right): O top-right, I vertical left. Hold=S.
const HC_ROUTE8: PcSolution[] = [
  {
    holdPiece: 'S',
    placements: [
      { piece: 'L', cells: [{ col: 0, row: 15 }, { col: 1, row: 15 }, { col: 1, row: 16 }, { col: 1, row: 17 }], hint: 'L vertical, cols 0-1' },
      { piece: 'O', cells: [{ col: 2, row: 15 }, { col: 3, row: 15 }, { col: 2, row: 16 }, { col: 3, row: 16 }], hint: 'O, cols 2-3' },
      { piece: 'Z', cells: [{ col: 6, row: 15 }, { col: 5, row: 16 }, { col: 6, row: 16 }, { col: 5, row: 17 }], hint: 'Z vertical, cols 5-6' },
      { piece: 'J', cells: [{ col: 4, row: 15 }, { col: 5, row: 15 }, { col: 4, row: 16 }, { col: 4, row: 17 }], hint: 'J vertical, cols 4-5' },
      { piece: 'I', cells: [{ col: 7, row: 15 }, { col: 7, row: 16 }, { col: 7, row: 17 }, { col: 7, row: 18 }], hint: 'I vertical, col 7' },
      { piece: 'T', cells: [{ col: 3, row: 18 }, { col: 4, row: 18 }, { col: 5, row: 18 }, { col: 4, row: 19 }], hint: 'T fills gap' },
    ],
...
// Route 9 (fb_o_center): O center, I horizontal. Hold=S.
const HC_ROUTE9: PcSolution[] = [
  {
    holdPiece: 'S',
    placements: [
      { piece: 'J', cells: [{ col: 0, row: 15 }, { col: 0, row: 16 }, { col: 1, row: 16 }, { col: 2, row: 16 }], hint: 'J flat, cols 0-2' },
      { piece: 'I', cells: [{ col: 1, row: 15 }, { col: 2, row: 15 }, { col: 3, row: 15 }, { col: 4, row: 15 }], hint: 'I horizontal, row 15' },
      { piece: 'L', cells: [{ col: 5, row: 15 }, { col: 6, row: 15 }, { col: 7, row: 15 }, { col: 5, row: 16 }], hint: 'L flat, cols 5-7' },
      { piece: 'O', cells: [{ col: 8, row: 15 }, { col: 9, row: 15 }, { col: 8, row: 16 }, { col: 9, row: 16 }], hint: 'O, cols 8-9' },
      { piece: 'Z', cells: [{ col: 3, row: 16 }, { col: 4, row: 16 }, { col: 4, row: 17 }, { col: 5, row: 17 }], hint: 'Z flat, cols 3-5' },
      { piece: 'T', cells: [{ col: 3, row: 18 }, { col: 4, row: 18 }, { col: 5, row: 18 }, { col: 4, row: 19 }], hint: 'T fills gap' },
    ],
  },
...
// Route 4 (bonus_setup): I held, 7 pieces for PC (22-cell post-TST board).
// Hold=O, S, or Z. 2 I pieces placed (one from hold, one from bag3).
const MS2_ROUTE4: PcSolution[] = [
  {
    holdPiece: 'O',
    placements: [
      { piece: 'I', cells: [{ col: 0, row: 15 }, { col: 1, row: 15 }, { col: 2, row: 15 }, { col: 3, row: 15 }], hint: 'I horizontal, row 15' },
      { piece: 'S', cells: [{ col: 5, row: 16 }, { col: 5, row: 17 }, { col: 6, row: 17 }, { col: 6, row: 18 }], hint: 'S vertical, cols 5-6' },
      { piece: 'J', cells: [{ col: 4, row: 15 }, { col: 5, row: 15 }, { col: 4, row: 16 }, { col: 4, row: 17 }], hint: 'J vertical, cols 4-5' },
      { piece: 'Z', cells: [{ col: 6, row: 16 }, { col: 7, row: 16 }, { col: 7, row: 17 }, { col: 8, row: 17 }], hint: 'Z flat, cols 6-8' },
      { piece: 'I', cells: [{ col: 6, row: 15 }, { col: 7, row: 15 }, { col: 8, row: 15 }, { col: 9, row: 15 }], hint: 'I horizontal, row 15 right' },
      { piece: 'L', cells: [{ col: 8, row: 16 }, { col: 9, row: 16 }, { col: 9, row: 17 }, { col: 9, row: 18 }], hint: 'L vertical, cols 8-9' },
      { piece: 'T', cells: [{ col: 3, row: 18 }, { col: 4, row: 18 }, { col: 5, row: 18 }, { col: 4, row: 19 }], hint: 'T fills gap' },
    ],
  },
  {
    ...
    placements: [
      { piece: 'I', cells: [{ col: 0, row: 15 }, { col: 1, row: 15 }, { col: 2, row: 15 }, { col: 3, row: 15 }], hint: 'I horizontal, row 15' },
      { piece: 'I', cells: [{ col: 9, row: 15 }, { col: 9, row: 16 }, { col: 9, row: 17 }, { col: 9, row: 18 }], hint: 'I vertical, col 9' },
      { piece: 'L', cells: [{ col: 6, row: 17 }, { col: 7, row: 17 }, { col: 8, row: 17 }, { col: 6, row: 18 }], hint: 'L horizontal, cols 6-8' },
      { piece: 'Z', cells: [{ col: 6, row: 15 }, { col: 5, row: 16 }, { col: 6, row: 16 }, { col: 5, row: 17 }], hint: 'Z vertical, cols 5-6' },
      { piece: 'O', cells: [{ col: 7, row: 15 }, { col: 8, row: 15 }, { col: 7, row: 16 }, { col: 8, row: 16 }], hint: 'O, cols 7-8' },
      { piece: 'J', cells: [{ col: 4, row: 15 }, { col: 5, row: 15 }, { col: 4, row: 16 }, { col: 4, row: 17 }], hint: 'J vertical, cols 4-5' },
      { piece: 'T', cells: [{ col: 3, row: 18 }, { col: 4, row: 18 }, { col: 5, row: 18 }, { col: 4, row: 19 }], hint: 'T fills gap' },
  ...
  },
  {
    ...
    placements: [
      ...
      { piece: 'S', cells: [{ col: 5, row: 16 }, { col: 5, row: 17 }, { col: 6, row: 17 }, { col: 6, row: 18 }], hint: 'S vertical, cols 5-6' },
      { piece: 'J', cells: [{ col: 4, row: 15 }, { col: 5, row: 15 }, { col: 4, row: 16 }, { col: 4, row: 17 }], hint: 'J vertical, cols 4-5' },
      { piece: 'L', cells: [{ col: 6, row: 15 }, { col: 7, row: 15 }, { col: 8, row: 15 }, { col: 6, row: 16 }], hint: 'L flat, cols 6-8' },
      { piece: 'O', cells: [{ col: 7, row: 16 }, { col: 8, row: 16 }, { col: 7, row: 17 }, { col: 8, row: 17 }], hint: 'O, cols 7-8' },
      { piece: 'T', cells: [{ col: 3, row: 18 }, { col: 4, row: 18 }, { col: 5, row: 18 }, { col: 4, row: 19 }], hint: 'T fills gap' },
    ],
  },
];
